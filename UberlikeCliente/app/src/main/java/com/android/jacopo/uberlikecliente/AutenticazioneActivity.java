    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                login = new LoginTask();
                login.execute(username.getText().toString(), password.getText().toString(), "0");
        ...
        if(msp.getBoolean("session",false))
        {
            ...
            username.setText(msp.getString("username", "defValue"));
        ...
        */
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://uberlikeapp.altervista.org/login.php");
        ...
        protected void onPostExecute(String result) {
            ...
            else
            {
                if(result.equals("true")) {
                    ...
                    Toast.makeText(AutenticazioneActivity.this, "Benvenuto " + username.getText().toString(), Toast.LENGTH_SHORT).show();
