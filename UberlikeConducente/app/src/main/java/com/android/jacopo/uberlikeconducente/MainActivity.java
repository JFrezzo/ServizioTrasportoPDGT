...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.fragment_container, richiesteFragment);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_servizi) {
            ...
            startActivity(new Intent(MainActivity.this, EsciActivity.class));
        }
        else if (id == R.id.nav_posizione) {

            startActivity(new Intent(MainActivity.this, AggiornaActivity.class));
        }
